...
class Request
{
     ...
     */
    public final function user($key = null)
    {
     ...
     * @return string|null The value of the wanted param from server params
     */
    public final function server($key, $validate = null)
    {
     ...
     */
    public final function query($key, $validate = null)
    {
     ...
     * @param string|null $validate Rules for validation of the variable
     * @return string|null The value of the wanted param from header
     */
    public final function header($key, $validate = null)
    {
     ...
     * @param string $key The key of the variable on the list
     * @param string|null $validate Rules for validation of the variable
     * @return array|mixed|null The value of the wanted param from user input
     */
    public final function inputParam($key, $validate = null)
    {
     ...
     * @return array|mixed All parameters which developer need after validation. If is not validate correct it will return FALSE.
     */
    public final function inputParams($vars = [])
    {
        if (empty($vars)) {
     ...
     * @return \Engine\Http\Request Request class
     */
     ...
     * @param string|null $validate Rules for validation of the variable
     * @return mixed|null The value of the wanted param from request
     */
    private function _returnParam($key, $array = [], $validate = null)
    {
